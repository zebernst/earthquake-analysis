...
```{r map-all-quakes, echo=TRUE, fig.width=9, fig.align='center'}
...
```{r map-high-mag, echo=TRUE, warning=FALSE, fig.width=9, fig.align='center'}
quakes_power <- quakes %>%
  filter(mag > 5.5) %>% 
...
```{r us-quakes, message=FALSE, warning=FALSE, echo=TRUE, fig.width=9, fig.align='center'}
quakes_us <- quakes %>% 
...
```{r us-density, warning=FALSE, message=FALSE, echo=TRUE, fig.align='center'}
