...
```{r timeseries, echo=TRUE, warning=FALSE, fig.align='center'}
...
```{r map_allquakes, echo=TRUE, fig.width=9, fig.align='center'}
...
```{r map_highmag, echo=TRUE, warning=FALSE, fig.width=9, fig.align='center'}
quakesPower <- quakes %>%
  filter(mag > 5.5) %>% 
...
```{r network, echo=TRUE, message=FALSE, warning=FALSE, fig.height=7, fig.width=8, fig.align='center'}
...
```{r bimodal, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r us_quakes, message=FALSE, warning=FALSE, echo=TRUE, fig.width=9, fig.align='center'}
quakes_us <- quakes %>% 
...
```{r us_density, warning=FALSE, message=FALSE, echo=TRUE, fig.align='center'}
...
```{r water-based, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center'}
seabased <- quakes %>% 
  filter(tsunami==1)
